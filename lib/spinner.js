...
export class LfSpinner extends LitElement {
	static styles = css`
		...
		:host {
			...
			--_lf-spinner-accent-color: var(--lf-spinner-accent-color, #e30613); /* red */
			--_lf-spinner-divider-color: var(--lf-spinner-divider-color, #fff);
			--lf-spinner-animation-curve: cubic-bezier(.53, 0, .49, 1);
	    ...
	    animation: spinner-draw-dash var(--lf-spinner-animation-time) infinite var(--lf-spinner-animation-curve);
		}
	    ...
	    animation: forward-line-rotate var(--lf-spinner-animation-time) infinite cubic-bezier(.51, .04, .46, .94);
		}

		.lf-spinner-back-line {
	    transform: rotate(7deg);
	    animation: back-line-rotate var(--lf-spinner-animation-time) infinite var(--lf-spinner-animation-curve);
	  }
	`;
