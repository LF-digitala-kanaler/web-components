...
/*
	TODO:
	- [ ] "closable" vs. "dismissible"
	- [ ] Screen reader labels
	- [x] Fix button looking strange when using slot.
...
/**
	...
	@property {'info', 'success', 'warning', 'danger'} [variant=info] Variant of Alert.
...
export class LfAlert extends LitElement {
	...
	constructor() {
		...
		this.setAttribute("aria-label", LfAlert.alertLabels[this.variant || 'info'])
	}
