...
export class LfButton extends LitElement {
	static styles = css`
		:host {
			...
			--_lf-button-hover-outline-color: var(
				...
				--_lf-button-on-container-color:
				var(--lf-button-on-secondary-container-color, transparent);
			--_lf-button-height: var(--lf-button-height, 40px);
			--lf-spinner-divider-color: var(--_lf-button-container-color);
			--_lf-button-container-padding: var(--lf-button-container-padding-y)
				var(--lf-button-container-padding-x);
		...
		button {
			...
			border: var(--_lf-button-outline-width) solid
				var(--_lf-button-outline-color);
			width: 100%;
		...
		:host button:focus-visible {
			outline: var(--lf-focus-ring-width, 4px) solid
				var(--lf-focus-ring-color, #fdd835);
		}
		...
		:host([variant="primary"]) {
			...
			--_lf-button-accent-color: var(--lf-button-primary-accent-color, #fff);
		...
		:host([size="small"]) {
			...
			--_lf-button-container-padding: var(--lf-button-container-small-padding-y)
				var(--lf-button-container-small-padding-x);
			line-height: 1;
		}
		...
		:host([size="large"]) {
			...
			--_lf-button-container-padding: var(--lf-button-container-large-padding-y)
				var(--lf-button-container-large-padding-x);
			line-height: 1.2;
		}
	...
	renderLoadingState() {
		return html` <div class="button__label-group">
			<div class="button__label">Laddar...</div>
			...
			<button>
				${this.loading
					...
					: html`
							...
							<slot name="end">
								${this.arrow
									? html`<div part="arrow" class="arrow"></div>`
									: ""}
							</slot>
						`}
			</button>
